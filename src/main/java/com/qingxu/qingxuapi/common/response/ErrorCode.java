...
public enum ErrorCode {
    ...
    ROLE_NOT_FOUND("ROLE_NOT_FOUND", "角色不存在", HttpStatus.NOT_FOUND),
    ROLE_CODE_DUPLICATE("ROLE_CODE_DUPLICATE", "角色编码已存在", HttpStatus.BAD_REQUEST),
    ROLE_ADMIN_CANNOT_DELETE("ROLE_ADMIN_CANNOT_DELETE", "admin角色不可删除", HttpStatus.BAD_REQUEST),
    ROLE_ADMIN_CANNOT_DISABLE("ROLE_ADMIN_CANNOT_DISABLE", "admin角色不可禁用", HttpStatus.BAD_REQUEST),
    ROLE_HAS_USERS("ROLE_HAS_USERS", "角色存在关联用户不可删除", HttpStatus.BAD_REQUEST),
    ROLE_MENU_NOT_FOUND("ROLE_MENU_NOT_FOUND", "分配的菜单ID不存在", HttpStatus.BAD_REQUEST),
