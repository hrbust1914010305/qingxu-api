...
public enum ErrorCode {
    ...
    FILE_EMPTY("FILE_EMPTY", "文件不能为空", HttpStatus.BAD_REQUEST),
    FILE_TOO_LARGE("FILE_TOO_LARGE", "文件大小超过限制", HttpStatus.BAD_REQUEST),
    FILE_TYPE_NOT_ALLOWED("FILE_TYPE_NOT_ALLOWED", "文件类型不允许", HttpStatus.BAD_REQUEST),
    FILE_NOT_FOUND("FILE_NOT_FOUND", "文件不存在", HttpStatus.NOT_FOUND),
    FILE_UPLOAD_SESSION_NOT_FOUND("FILE_UPLOAD_SESSION_NOT_FOUND", "上传会话不存在", HttpStatus.NOT_FOUND),
    FILE_UPLOAD_SESSION_EXPIRED("FILE_UPLOAD_SESSION_EXPIRED", "上传会话已过期", HttpStatus.BAD_REQUEST),
    FILE_CHUNK_INDEX_INVALID("FILE_CHUNK_INDEX_INVALID", "分片序号非法", HttpStatus.BAD_REQUEST),
    FILE_CHUNK_MISSING("FILE_CHUNK_MISSING", "文件分片缺失", HttpStatus.BAD_REQUEST),
    FILE_CHUNK_SIZE_INVALID("FILE_CHUNK_SIZE_INVALID", "文件分片大小不匹配", HttpStatus.BAD_REQUEST),
    FILE_MERGE_FAILED("FILE_MERGE_FAILED", "文件合并失败", HttpStatus.INTERNAL_SERVER_ERROR),
    FILE_DELETE_FAILED("FILE_DELETE_FAILED", "文件删除失败", HttpStatus.INTERNAL_SERVER_ERROR),
    KNOWLEDGE_FILE_BIZ_TYPE_INVALID("KNOWLEDGE_FILE_BIZ_TYPE_INVALID", "文件业务类型不是 knowledge，不能解析", HttpStatus.BAD_REQUEST),
    KNOWLEDGE_FILE_TYPE_NOT_SUPPORTED("KNOWLEDGE_FILE_TYPE_NOT_SUPPORTED", "文件类型暂不支持知识库解析", HttpStatus.BAD_REQUEST),
    KNOWLEDGE_INDEX_JOB_RUNNING("KNOWLEDGE_INDEX_JOB_RUNNING", "该文件已有运行中的解析任务", HttpStatus.BAD_REQUEST),
    KNOWLEDGE_DOCUMENT_NOT_FOUND("KNOWLEDGE_DOCUMENT_NOT_FOUND", "知识库文档不存在", HttpStatus.NOT_FOUND),
    KNOWLEDGE_BASE_NOT_FOUND("KNOWLEDGE_BASE_NOT_FOUND", "知识库不存在", HttpStatus.NOT_FOUND),
    KNOWLEDGE_INDEX_JOB_NOT_FOUND("KNOWLEDGE_INDEX_JOB_NOT_FOUND", "知识库解析任务不存在", HttpStatus.NOT_FOUND),
